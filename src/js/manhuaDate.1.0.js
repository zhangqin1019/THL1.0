...
$(function() {
    $.fn.manhuaDate = function(options) {
        ...
        $mhInput.live(options.Event,function(e){                                            
            ...
            var doct_w = $(window).width()-264;
            var calender_left = parseInt($(".calender").css("left"));        
            if(calender_left>doct_w) {
                $(".calender").animate({left:doct_w});
            };
        });     
        //当鼠标离开控件上面的时候延迟0.3秒关闭
